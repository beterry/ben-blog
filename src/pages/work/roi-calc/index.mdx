...
description: How I planned, designed, and prototyped a sales tool to help customer's discover the hidden benefits of direct mail.
date: 2020-08-30
code: https://github.com/beterry/roi-calc
deployed: https://beterry.github.io/roi-calc/
display: ./images/before/2_After@2x.png
tags: ["UX Design", "Prototyping", "React"]
---
...
/>
<p class="caption">The approved wireframe layout for the calculator.</p>
...
/>
<p class="caption">The finished calculator design.</p>

## Developing a prototype

After the design was approved, I worked to develop a prototype so my management team could have a better understanding of how the experience would function. Although Adobe XD has powerful prototyping features, I wanted to develop the prototype with web technology as coding practice.

I then worked with Mail Shark’s front-end developer to supply assets and aid development of the deployable product. 

<LinkOutButton url="https://beterry.github.io/roi-calc/">View my Prototype</LinkOutButton>
<LinkOutButton url="https://github.com/beterry/roi-calc">View Github Repo</LinkOutButton>
...
Before the production build of the calculator was deployed, I conducted user testing to understand what users liked and didn't like about the design, interface, and overall experience. I was then able to incorporate the feedback into the project, which improved the overall experience.
...
I’m very satisfied with the final look of this project. The user interface is modern and takes advantage of user interaction (not text) to tell the desired story, that direct mail is a great investment.
...
export const pageQuery = graphql`
    query roiQuery{
        ...
        wire: allFile(filter: {relativeDirectory: {eq: "roi-calc/images/wire"}}, sort: {order: ASC, fields: name}) {
            edges {
                node {
                    childImageSharp {
                        fluid {
        ...
        proto: allFile(filter: {relativeDirectory: {eq: "roi-calc/images/proto"}}, sort: {order: ASC, fields: name}) {
            edges {
                node {
                    childImageSharp {
                        fluid {
        ...
        before: allFile(filter: {relativeDirectory: {eq: "roi-calc/images/before"}}) {
            edges {
                node {
                    childImageSharp {
                        fluid {
