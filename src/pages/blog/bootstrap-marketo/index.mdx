...
tags: ["Bootstrap", "Marketo", "Marketing"]
---
...
<p class='caption'>The design I mocked up in Adobe XD.</p>
...
<p class='caption'>A screenshot of the fully developed local prototype.</p>
...
<p class='caption'>Marketo provides starting code that provides examples of how to create editable elements.</p>

![Screenshot of Marketo](./marketo-1.png)
<p class='caption'>When I copied the code to Marketo's online editor and clicked preview, this is what it looked like.</p>
...
<p class='caption'>Right panel displays editable elements in the template.</p>

![Screenshot of template editor](./marketo-3.png)
<p class='caption'>Double clicking on the Main Heading element brings up a rich text editor.</p>
